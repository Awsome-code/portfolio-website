...
export default function ResumeCard({
  ...
  return <div className="flex items-start space-x-6 bg-blue-950/20 p-4 sm:p-8 rounded-md">
    <div className="w-10 h-10 sm:w-14 sm:h14 bg-blue-900 rounded-full grid place-items-center">
